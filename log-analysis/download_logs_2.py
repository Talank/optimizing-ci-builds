        ...
        if workflow_name != last_log_downloaded:
            ...
            with open(os.path.join(analysis_dir, f"{ci_analyzes_branch}.csv"), 'a') as f:
                ...
                for job in workflow_run['jobs']:
                    ...
                    # Analysis of failure category
                    # get raw log file
                    # raw_log_dir = os.path.join(raw_log_dir, ci_analyzes_branch, f"{project}.log")
                    
                    # # read the raw log file and extract the failure category
                    # with open(raw_log_dir, 'r') as f:
                    #     category = ""
                    #     for line in f:
                    #         if "Failure category" in line:
